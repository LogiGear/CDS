...
public class SwaggerConfiguration {
    ...
    private static final Contact API_AUTHOR_CONTACT = new Contact("BanhsBao", "www.logigear.com",
            "bao.chau.huynh@logigear.com");
    private static final String BASE_API_PACKAGE = "com.logigear.crm.manager.controller";
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2).securityContexts(Arrays.asList(securityContext()))
                ...
                .apis(RequestHandlerSelectors.basePackage(BASE_API_PACKAGE)).paths(PathSelectors.any()).build()
