...
public class QEmployeeDetails extends EntityPathBase<EmployeeDetails> {
    ...
    private static final long serialVersionUID = -1103861719L;
    ...
    public final SimplePath<File> file = createSimple("file", File.class);
    ...
    public final SetPath<Project, SimplePath<Project>> projects = this.<Project, SimplePath<Project>>createSet("projects", Project.class, SimplePath.class, PathInits.DIRECT2);
    ...
    public final SetPath<Department, QDepartment> subordinatesDepartment = this.<Department, QDepartment>createSet("subordinatesDepartment", Department.class, QDepartment.class, PathInits.DIRECT2);
    ...
    public final SimplePath<User> user = createSimple("user", User.class);
